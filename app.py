...
def ramadan_growth_mindset_challenge():
    ...
    ramadan_start = datetime.date(2024, 3, 11) # Example Ramadan Start Date. Adjust as needed.
    ...
    #Additional fields
    suhoor_time = st.time_input("Saheri Time ⏰", datetime.time(5, 30))
